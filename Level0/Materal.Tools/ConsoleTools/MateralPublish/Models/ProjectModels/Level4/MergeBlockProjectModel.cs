...
namespace MateralPublish.Models.ProjectModels.Level4
{
    public class MergeBlockProjectModel : BaseProjectModel
    {
        ...
        {
            _vsixDirectoryInfo = new(Path.Combine(ProjectDirectoryInfo.FullName, "Src", "MateralMergeBlockVSIX"));
        }
        /// <summary>
        /// 更新版本号
        /// </summary>
        ...
        {
            if (PublishHelper.PublishDirectoryInfo is null) return;
            FileInfo vsixCsprojFileInfo = new(Path.Combine(_vsixDirectoryInfo.FullName, "MateralMergeBlockVSIX.csproj"));
            ...
            FileInfo vsixFileInfo = new(Path.Combine(publishDirectoryInfo.FullName, "MateralMergeBlockVSIX.vsix"));
