...
namespace Materal.Utils.Http
{
    ...
    public interface IWebServiceHelper
    {
        ...
        /// <param name="soapVersion"></param>
        /// <returns></returns>
        Task<object?> SendSoapObjectAsync(string url, string serviceName, string serviceNamespace, Dictionary<string, object?>? data = null, SoapVersionEnum soapVersion = SoapVersionEnum.Soap1_2);
        /// <summary>
        /// 发送Soap请求
        /// </summary>
        /// <param name="url"></param>
        ...
        /// <param name="soapVersion"></param>
        /// <returns></returns>
        Task<XmlNode?> SendSoapNodeAsync(string url, string serviceName, string serviceNamespace, Dictionary<string, object?>? data = null, SoapVersionEnum soapVersion = SoapVersionEnum.Soap1_2);
        /// <summary>
        /// 发送Soap1.1请求
        /// </summary>
        /// <param name="url"></param>
