...
//        /// 构造方法
//        /// </summary>
//        public WebSocketLoggerHandler(LoggerRuntime loggerRuntime, WebSocketLoggerTargetConfigModel targetConfig) : base(loggerRuntime, targetConfig)
//        {
//        }
...
//        //private readonly Timer _verifyWebSocketServerTimer = new(VerifyWebSocketServerTimerElapsed);
...
//        //protected override void Handler(LoggerRuleConfigModel rule, WebSocketLoggerTargetConfigModel target, LoggerHandlerModel model, LoggerConfig loggerConfig, ILoggerLog loggerLog)
//        //{
...
//        //        try
//        //        {
//        //            connection.Send(new LogMessageModel(target, model, loggerConfig).ToJson());
//        //        }
//        //        catch (Exception ex)
//        //        {
...
//        //public void VerifyWebSocketServerTimerElapsed(object? stateInfo)
//        //{
