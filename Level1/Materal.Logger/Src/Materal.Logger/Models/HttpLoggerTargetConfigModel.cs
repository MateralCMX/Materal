...
namespace Materal.Logger.Models
{
    ...
    public class HttpLoggerTargetConfigModel : LoggerTargetConfigModel
    {
        ...
        /// 获得日志处理器
        /// </summary>
        public override ILoggerHandler GetLoggerHandler() => new HttpLoggerHandler();
        ...
        private string _format = "{\"CreateTime\":\"${DateTime}\",\"Application\":\"${Application}\",\"Level\":\"${Level}\",\"Scope\":\"${Scope}\",\"CategoryName\":\"${CategoryName}\",\"MachineName\":\"${MachineName}\",\"ProgressID\":\"${ProgressID}\",\"ThreadID\":\"${ThreadID}\",\"Message\":\"${Message}\",\"Exception\":\"${Exception}\"}";
        /// <summary>
        /// 格式化
        /// </summary>
