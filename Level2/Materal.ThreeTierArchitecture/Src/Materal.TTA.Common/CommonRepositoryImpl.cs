...
namespace Materal.TTA.Common
{
        ...
        where TEntity : class, IEntity
    {
        ...
        /// <returns></returns>
        public virtual (List<TEntity> data, PageModel pageInfo) Paging(PageRequestModel pageRequestModel) => Paging(pageRequestModel.GetSearchExpression<TEntity>(), pageRequestModel);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="pageRequestModel"></param>
        /// <param name="orderExpression"></param>
        /// <returns></returns>
        public virtual (List<TEntity> data, PageModel pageInfo) Paging(PageRequestModel pageRequestModel, Expression<Func<TEntity, object>> orderExpression) => Paging(pageRequestModel.GetSearchExpression<TEntity>(), orderExpression, pageRequestModel);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="pageRequestModel"></param>
        ...
        /// <param name="sortOrder"></param>
        /// <returns></returns>
        public virtual (List<TEntity> data, PageModel pageInfo) Paging(PageRequestModel pageRequestModel, Expression<Func<TEntity, object>> orderExpression, SortOrder sortOrder) => Paging(pageRequestModel.GetSearchExpression<TEntity>(), orderExpression, sortOrder, pageRequestModel);
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        /// <param name="pageRequestModel"></param>
        /// <returns></returns>
        public virtual (List<TEntity> data, PageModel pageInfo) Paging(Expression<Func<TEntity, bool>> filterExpression, PageRequestModel pageRequestModel) => Paging(filterExpression, pageRequestModel.PageIndex, pageRequestModel.PageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageRequestModel"></param>
        /// <returns></returns>
        public virtual (List<TEntity> data, PageModel pageInfo) Paging(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, PageRequestModel pageRequestModel) => Paging(filterExpression, orderExpression, pageRequestModel.PageIndex, pageRequestModel.PageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageRequestModel"></param>
        /// <returns></returns>
        public virtual (List<TEntity> data, PageModel pageInfo) Paging(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, SortOrder sortOrder, PageRequestModel pageRequestModel) => Paging(filterExpression, orderExpression, sortOrder, pageRequestModel.PageIndex, pageRequestModel.PageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public virtual (List<TEntity> data, PageModel pageInfo) Paging(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, int pageIndex, int pageSize) => Paging(filterExpression, orderExpression, SortOrder.Ascending, pageIndex, pageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public abstract (List<TEntity> data, PageModel pageInfo) Paging(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, SortOrder sortOrder, int pageIndex, int pageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="pageRequestModel"></param>
        /// <returns></returns>
        public virtual async Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(PageRequestModel pageRequestModel) => await PagingAsync(pageRequestModel.GetSearchExpression<TEntity>(), pageRequestModel);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="pageRequestModel"></param>
        /// <param name="orderExpression"></param>
        /// <returns></returns>
        public virtual async Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(PageRequestModel pageRequestModel, Expression<Func<TEntity, object>> orderExpression) => await PagingAsync(pageRequestModel.GetSearchExpression<TEntity>(), orderExpression, pageRequestModel);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="pageRequestModel"></param>
        ...
        /// <param name="sortOrder"></param>
        /// <returns></returns>
        public virtual async Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(PageRequestModel pageRequestModel, Expression<Func<TEntity, object>> orderExpression, SortOrder sortOrder) => await PagingAsync(pageRequestModel.GetSearchExpression<TEntity>(), orderExpression, sortOrder, pageRequestModel);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        /// <param name="pageRequestModel"></param>
        /// <returns></returns>
        public virtual async Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(Expression<Func<TEntity, bool>> filterExpression, PageRequestModel pageRequestModel) => await PagingAsync(filterExpression, pageRequestModel.PageIndex, pageRequestModel.PageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageRequestModel"></param>
        /// <returns></returns>
        public virtual async Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, PageRequestModel pageRequestModel) => await PagingAsync(filterExpression, orderExpression, pageRequestModel.PageIndex, pageRequestModel.PageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageRequestModel"></param>
        /// <returns></returns>
        public virtual async Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, SortOrder sortOrder, PageRequestModel pageRequestModel) => await PagingAsync(filterExpression, orderExpression, sortOrder, pageRequestModel.PageIndex, pageRequestModel.PageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public virtual async Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, int pageIndex, int pageSize) => await PagingAsync(filterExpression, orderExpression, SortOrder.Ascending, pageIndex, pageSize);
        /// <summary>
        /// 分页查询
        /// </summary>
        /// <param name="filterExpression"></param>
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public virtual Task<(List<TEntity> data, PageModel pageInfo)> PagingAsync(Expression<Func<TEntity, bool>> filterExpression, Expression<Func<TEntity, object>> orderExpression, SortOrder sortOrder, int pageIndex, int pageSize)
