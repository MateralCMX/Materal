...
namespace MBC.Core.CodeGenerator
{
    public class InitProject : IMateralBaseCoreCodeGeneratorPlug
    {
        ...
        private static void CreateDBContextFactory(DomainPlugModel model)
        {
            ...
            codeContent.AppendLine($"using MBC.{model.EFRepositoryProject.ProjectName}.Common;");
            codeContent.AppendLine($"");
        ...
        private static void CreateDIManager(DomainPlugModel model)
        {
            ...
            codeContent.AppendLine($"using MBC.{model.WebAPIProject.ProjectName}.Common;");
            ...
            codeContent.AppendLine($"");
            codeContent.AppendLine($"namespace MBC.{model.WebAPIProject.ProjectName}.WebAPI");
            codeContent.AppendLine($"{{");
            codeContent.AppendLine($"    /// <summary>");
            ...
            codeContent.AppendLine($"        /// <returns></returns>");
            codeContent.AppendLine($"        public virtual IServiceCollection Add{model.WebAPIProject.ProjectName}Service(IServiceCollection services) => AddMBC{model.WebAPIProject.ProjectName}Service(services);");
            codeContent.AppendLine($"    }}");
            codeContent.AppendLine($"    /// <summary>");
            ...
            codeContent.AppendLine($"        /// <returns></returns>");
            codeContent.AppendLine($"        public virtual IServiceCollection AddMBC{model.WebAPIProject.ProjectName}Service(IServiceCollection services, Action<SwaggerGenOptions>? swaggerGenConfig = null)");
            codeContent.AppendLine($"        {{");
            ...
            codeContent.AppendLine($"            {{");
            codeContent.AppendLine($"                $\"{{basePath}}MBC.{model.WebAPIProject.ProjectName}.WebAPI.xml\",");
            codeContent.AppendLine($"                $\"{{basePath}}MBC.{model.WebAPIProject.ProjectName}.DataTransmitModel.xml\",");
            codeContent.AppendLine($"                $\"{{basePath}}MBC.{model.WebAPIProject.ProjectName}.PresentationModel.xml\"");
            codeContent.AppendLine($"            }};");
        ...
        private static void CreateProgram(DomainPlugModel model)
        {
            ...
            codeContent.AppendLine($"    /// </summary>");
            codeContent.AppendLine($"    public partial class Program : MBCProgram");
            codeContent.AppendLine($"    {{");
            codeContent.AppendLine($"        /// <summary>");
            ...
            codeContent.AppendLine($"            WebApplication app = MBCProgram.MBCStart(args, services =>");
            codeContent.AppendLine($"            {{");
