 ...
 * 暴露成员
 */
const props = defineProps<{ dataModelField: DataModelField }>();
/**
 * 事件
 */
 ...
 * 添加时间选择器数据
 */
const addDateTimePickerData = () => {
    const data = new DatePickerComponentModel(props.dataModelField.ID, "DateTime");
    emits("newData", data);
}
</script>