...
namespace Materal.Gateway.WebAPI.Filters
{
    ...
    public class ExceptionFilter : IExceptionFilter
    {
        ...
        private ResultModel GetResult(ExceptionContext context)
        {
            ...
            {
                GatewayException _ => ResultModel.Fail(message),
                AspectInvocationException aspectInvocationException =>
                aspectInvocationException.InnerException is GatewayException
        ...
        private string GetErrorMessage(Exception exception)
        {
            ...
            switch (exception)
            {
                ...
                case MateralHttpException httpException:
                    ...
                    break;
                case GatewayException materalAPPException:
                    message = materalAPPException.Message;
                    break;
                case AspectInvocationException aspectInvocationException:
                    message = aspectInvocationException.InnerException is GatewayException ?
