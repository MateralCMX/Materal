...
namespace Materal.Workflow.StepDatas
{
    ...
    /// 条件循环节点数据
    /// </summary>
    public class WhileStepData : StepData, IStepData
    {
        /// <summary>
        /// 条件数据
        /// </summary>
        ...
        public WhileStepData(object leftValue, ValueSourceEnum leftValueSource, ComparisonTypeEnum comparisonType, object rightValue, ValueSourceEnum rightValueSource)
        {
