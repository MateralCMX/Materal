...
namespace Materal.MergeBlock.Consul
{
    ...
    /// Consul服务
    /// </summary>
    public class ConsulServer(IConsulService consulService, IEnumerable<WebModuleConsulConfig> webModuleConsulConfigs, IOptionsMonitor<MergeBlockConsulConfig> mergeBlockConsulConfig) : IHostedService
    {
        ...
        /// <returns></returns>
        private async Task RegisterConsulAsync(MergeBlockConsulConfig config)
        {
