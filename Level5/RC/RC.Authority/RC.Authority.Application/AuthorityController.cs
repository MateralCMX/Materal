namespace RC.Authority.Application
{
    ...
    public abstract class AuthorityController : MergeBlockControllerBase
    {
    }
    /// <summary>
    /// Authority控制器
    ...
    [Route("AuthorityAPI/[controller]/[action]")]
    public abstract class AuthorityController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService> : MergeBlockControllerBase<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService>
