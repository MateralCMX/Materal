namespace RC.Demo.Application
{
    ...
    public abstract class DemoController : MergeBlockControllerBase
    {
    }
    /// <summary>
    /// Demo控制器
    ...
    [Route("DemoAPI/[controller]/[action]")]
    public abstract class DemoController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService> : MergeBlockControllerBase<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService>
