namespace RC.ServerCenter.Application
{
    ...
    public abstract class ServerCenterController : MergeBlockControllerBase
    {
    }
    /// <summary>
    /// ServerCenter控制器
    ...
    [Route("ServerCenterAPI/[controller]/[action]")]
    public abstract class ServerCenterController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService> : MergeBlockControllerBase<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService>
