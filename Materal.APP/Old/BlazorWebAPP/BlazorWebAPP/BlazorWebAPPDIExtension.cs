...
namespace BlazorWebAPP
{
    ...
    public static class BlazorWebAPPDIExtension
    {
        ...
        public static void AddBlazorWebAPPServices(this IServiceCollection services)
        {
            ...
            services.AddGrpcClient<StringHelper.StringHelperClient>(BlazorWebAPPConfig.MateralAppUrlUrl);
            services.AddGrpcClient<User.UserClient>(BlazorWebAPPConfig.AuthorityUrl);
            services.AddAutoMapperService(Assembly.Load("BlazorWebAPP"));
        }
        /// <summary>
        /// 添加一个Grpc客户端
        /// </summary>
