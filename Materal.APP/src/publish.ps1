...
$applicationPrefixs = "Authority","ConfigCenter","ConfigCenter.Environment","Deploy","Materal.APP"#前缀名 "Authority","ConfigCenter","ConfigCenter.Environment","Deploy","Materal.APP","WebAPP"
