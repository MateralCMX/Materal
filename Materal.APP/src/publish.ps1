...
$applicationPrefixs = "Authority","ConfigCenter","ConfigCenter.Environment","Deploy","Materal.APP","WebAPP"#前缀名 "Authority","Log","UploadFile","Gateway", "AuthCode", "SceneManagement", "OddNumber", "OrganizationManage","SensitiveWord","LandTransfer", "DistrictManage", "Message", "PartyBuilding", "ResourceSharing", "Monograph"
