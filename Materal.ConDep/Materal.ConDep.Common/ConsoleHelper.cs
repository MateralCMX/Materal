...
namespace Materal.ConDep.Common
{
    public static class ConsoleHelper
    {
        ...
        /// <param name="subTitle">副标题</param>
        /// <param name="consoleColor">颜色</param>
        public static void ConDepServerWriteLine(string message, string subTitle = null, ConsoleColor consoleColor = ConsoleColor.White)
        {
            WriteLine("ConDepServer", message, subTitle, consoleColor);
        }
        /// <summary>
        /// WebSocket服务器控制台输出
        /// </summary>
        ...
        /// <param name="subTitle">副标题</param>
        /// <param name="consoleColor">颜色</param>
        public static void ConDepServerWrite(string message, string subTitle = null, ConsoleColor consoleColor = ConsoleColor.White)
        {
            Write("ConDepServer", message, subTitle, consoleColor);
        }
        /// <summary>
        /// WebSocket服务器控制台输出错误
        /// </summary>
        /// <param name="exception">错误</param>
        public static void ConDepServerErrorWriteLine(Exception exception)
        {
            ...
            ConDepServerWriteLine(message, null, ConsoleColor.Red);
        }
    }
}
