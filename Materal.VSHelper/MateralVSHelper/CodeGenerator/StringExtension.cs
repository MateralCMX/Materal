...
namespace MateralVSHelper.CodeGenerator
{
    public static class StringExtension
    {
        ...
        public static void SaveFile(this StringBuilder content, string path, string fileName)
        {
            content.ToString().SaveFile(path, fileName);
        }
        /// <summary>
        /// 写文件
        /// </summary>
        ...
        /// <param name="path"></param>
        /// <param name="fileName"></param>
        public static void SaveFile(this string content, string path, string fileName)
        {
