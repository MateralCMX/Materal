namespace Materal.Logger.OracleLogger
{
    ...
    public static partial class LoggerOptionsExtensions
    {
        ...
        public static LoggerOptions AddOracleTarget(this LoggerOptions options, string name, string connectionString, string? tableName = null, List<OracleFiled>? fileds = null)
        {
            OracleLoggerTargetOptions target = new()
            {
                Name = name,
