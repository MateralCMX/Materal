namespace RC.EnvironmentServer.Application
{
    ...
    public abstract class EnvironmentServerController : MergeBlockController
    {
    }
    /// <summary>
    /// EnvironmentServer控制器
    ...
    [Route("EnvironmentServerAPI/[controller]/[action]")]
    public abstract class EnvironmentServerController<TService> : MergeBlockController<TService>
    ...
    /// <typeparam name="TService"></typeparam>
    [Route("EnvironmentServerAPI/[controller]/[action]")]
    public abstract class EnvironmentServerController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService> : MergeBlockController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService>
