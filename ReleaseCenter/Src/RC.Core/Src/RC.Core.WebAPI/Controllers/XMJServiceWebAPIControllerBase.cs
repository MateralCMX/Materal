...
using RC.Core.PresentationModel;
...
namespace RC.Core.WebAPI.Controllers
{
    ...
    public abstract class RCWebAPIServiceControllerBase<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService> : RCWebAPIControllerBase
        where TAddRequestModel : class, IRequestModel, new()
        where TEditRequestModel : class, IEditRequestModel, IRequestModel, new()
        where TQueryRequestModel : IQueryRequestModel, IRequestModel, new()
        ...
        where TService : IBaseService<TAddModel, TEditModel, TQueryModel, TDTO, TListDTO>
    {
        ...
        /// 构造方法
        /// </summary>
        protected RCWebAPIServiceControllerBase()
        {
