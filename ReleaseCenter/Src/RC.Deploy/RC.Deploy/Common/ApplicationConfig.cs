...
namespace RC.Deploy.Common
{
    ...
    public class ApplicationConfig
    {
        ...
        /// 上传文件路径
        /// </summary>
        public static string UploadFilePath => Path.Combine(AppDomain.CurrentDomain.BaseDirectory, RCConfig.GetValue(nameof(UploadFilePath), "UploadFiles"));
        /// <summary>
        /// WinRar路径
        /// </summary>
        public static string WinRarPath => RCConfig.GetValue(nameof(WinRarPath), string.Empty);
        ...
        public static RewriteConfigModel RewriteConfig
        {
            get
            {
                ...
                _rewriteConfig = RCConfig.GetValueObject<RewriteConfigModel>(nameof(RewriteConfig));
